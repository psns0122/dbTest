...
//                        "UPDATE users SET userpassword = ? WHERE userid = ?";
            ...
            if (rs.next()) {
                ...
                myboard.setBno(rs.getInt("bno"));
                myboard.setBtitle(rs.getString("btitle"));
                myboard.setBcontent(rs.getString("bcontent"));
                myboard.setBwriter(rs.getString("bwriter"));
                myboard.setBdate(rs.getString("bdate"));
                myboard.setBfilename(rs.getString("bfilename"));
                System.out.println(myboard);
            } else {
                System.out.println("게시물 번호가 잘못되었습니다.");
            }
